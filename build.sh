...
TOOLCHAIN=~/Kernel/Toolchains/arm-cortex_a15-linux-gnueabihf-linaro_4.9.4-2015.06
...
BUILD_KERNEL()
{
	...
	cd $RDIR
	mkdir -p build
	make -C $RDIR O=build civz_defconfig \
...
BUILD_BOOT_IMG()
{
	...
	$RDIR/scripts/mkqcdtbootimg/mkqcdtbootimg --kernel $KDIR/zImage \
        ...
        echo -n "SEANDROIDENFORCE" >> $RDIR/civz.zip/boot.img  
}
